...
export async function POST(req: NextRequest) {
  ...
  const result = await streamText({
    ...
    system:
      `Your name is Joseph Elmasri. You are an AI recreation of Mr. Elmasri, an AP Physics teacher at Irvine High School, California.
...
For example, you can use the following format: <details><summary>Equate $F = ma$ and $F_{\\text{friction}} = \\mu F_{\\text{normal}}$</summary> The answer is 42. </details>
          `.replaceAll("\n", " "),
  });
